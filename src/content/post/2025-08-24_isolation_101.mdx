...
After writing `Workers` manually for a couple of years and forgetting to pass some inputs around, or bumping into [classloader leaks](https://github.com/apollographql/apollo-kotlin/issues/6266), I decided to investigate what could be done to make this process easier.
