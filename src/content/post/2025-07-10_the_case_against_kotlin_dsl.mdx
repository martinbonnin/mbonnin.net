...
If you're looking for a sample plugin that does't use `kotlin-dsl`, the [shadow plugin](https://github.com/GradleUp/shadow/blob/main/build.gradle.kts#L14) is a good example.
