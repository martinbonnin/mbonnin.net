...
_**Edit (January 2026): if you want to improve the interoperability and documentation of Gradle metadata, please contribute https://github.com/liutikas/gmm-wiki.**_  
...
Attributes
allow ["variant-aware" dependency resolution](https://docs.gradle.org/current/userguide/variant_aware_resolution.html).
...
It's detailed in [the docs](https://docs.gradle.org/current/userguide/variant_aware_resolution.html#sec:abm-algorithm). The algorithm contains 6 steps, 7 "for" loops, and ~20 "if" conditions. (Someone please compute the [Cyclomatic complexity](https://en.wikipedia.org/wiki/Cyclomatic_complexity) 🙏)
...
The Amper team has a [Gradle‑metadata‑aware resolver](https://github.com/JetBrains/amper/blob/45b8ce9f1ed8d652b7ce9742b85bbbc8422d0022/sources/dependency-resolution/src/org/jetbrains/amper/dependency/resolution/resolver.kt#L86), but I doubt it supports all the possible edge cases. (Please prove me wrong!)

The Bazel team gave up and instead is wrapping [Gradle in a separate process, just for dependency resolution](https://github.com/bazel-contrib/rules_jvm_external/pull/1357).
...
At a very high level, this is the same "declarative vs. imperative" age‑old question. POM is declarative and lacks
...
Photo from [Priscilla Du Preez 🇨🇦](https://unsplash.com/photos/one-red-apple-CoqJGsFVJtM)
